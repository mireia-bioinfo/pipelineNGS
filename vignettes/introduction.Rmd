...
output: 
  BiocStyle::html_document:
    ...
    self.contained: TRUE
vignette: >
  %\VignetteIndexEntry{Processing Sequencing data with pipelineNGS}
...
-   CUT&TAG for histone marks (`CT`).
-   CUT&RUN for transcription factors (`CR`).
...
The following chunk shows a minor example of how to run an analyses, in this case of paired-end (`type=PE`) CUT&TAG data (`seq_type="CT"`):
...
-   Additional parameters are added in the case of CUT&TAG samples, following the analysis described in: <https://yezhengstat.github.io/CUTTag_tutorial/#311_Alignment_to_HG38>
